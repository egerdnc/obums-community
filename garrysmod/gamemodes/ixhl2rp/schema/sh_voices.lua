...
Schema.voices.Add("Combine", "Combine", "Overwatch.", "npc/combine_soldier/vo/overwatch.wav")
...
Schema.voices.Add("Combine", "OVERTWATCH REQUEST RESERVE ACTIVATION", "Overwatch request reserve activation.", "npc/combine_soldier/vo/overwatchrequestreserveactivation.wav")
...
Schema.voices.Add("Combine", "REQUEST STIM", "Request stim dose.", "npc/combine_soldier/vo/requeststimdose.wav")
...
Schema.voices.Add("Combine", "SIGHT LINES", "Stay alert report sightlines.", "npc/combine_soldier/vo/stayalertreportsightlines.wav")
Schema.voices.Add("Combine", "HEAVY RESISTANCE", "Overwatch, be advised, we have heavy resistance.", "npc/combine_soldier/vo/heavyresistance.wav")
...
Schema.voices.Add("Combine", "Bellyaching", "Quit your bellyaching.", "npc/metropolice/mc1ans_bellyaching.wav")
...
Schema.voices.Add("Combine", "Partner", "I had to get you for a partner.", "npc/metropolice/mc1ans_hadtopartner.wav")
...
Schema.voices.Add("Combine", "Let me think", "Let me think about that.", "npc/metropolice/mc1ans_letmethink.wav")
...
Schema.voices.Add("Combine", "You expect me", "You expect me to believe that?", "npc/metropolice/mc1ans_youexpectme.wav")
...
Schema.voices.Add("Combine", "Better things", "I got better things to do.", "npc/metropolice/mc1que_betterthings.wav")
...
Schema.voices.Add("Combine", "Enlisting", "So, I'm thinking of enlisting.", "npc/metropolice/mc1que_enlisting.wav")
...
Schema.voices.Add("Combine", "Going to hell", "This whole place is going to hell. Well, not this place.", "npc/metropolice/mc1que_goingtohell.wav")
Schema.voices.Add("Combine", "Just thought", "I just thought of something. Uh, wait... maybe not.", "npc/metropolice/mc1que_justthought.wav")
Schema.voices.Add("Combine", "Kids", "I wouldn't have kids even if they let me.", "npc/metropolice/mc1que_kids.wav")
Schema.voices.Add("Combine", "Last job", "Beats the shit out of my last job.", "npc/metropolice/mc1que_lastjob.wav")
...
Schema.voices.Add("Combine", "Raise", "Supposedly, we're getting a raise next week.", "npc/metropolice/mc1que_raise.wav")
Schema.voices.Add("Combine", "Stimpatch", "I could use another stimpatch.", "npc/metropolice/mc1que_stimpatch.wav")
Schema.voices.Add("Combine", "Stomach", "My stomach is killing me.", "npc/metropolice/mc1que_stomach.wav")
Schema.voices.Add("Combine", "Stunsticks", "I hear we're not getting those new stunsticks this year.", "npc/metropolice/mc1que_stunsticks.wav")
Schema.voices.Add("Combine", "Ridiculous", "This is ridiculous.", "npc/metropolice/mc1que_thisridiculous.wav")
...
Schema.voices.Add("Combine", "Let them loose", "Let 'em loose!", "npc/metropolice/deploy02.wav")
...
Schema.voices.Add("Combine", "On the ground", "Stay where you are, get on the ground! Do it now!", "npc/metropolice/getonground.wav")
Schema.voices.Add("Combine", "Freeze", "Freeze!", "npc/metropolice/freeze.wav")
Schema.voices.Add("Combine", "On the ground", "Stay where you are, get on the ground! Do it now!", "npc/metropolice/getonground.wav")
Schema.voices.Add("Combine", "Freeze", "Freeze!", "npc/metropolice/freeze.wav")
Schema.voices.Add("Combine", "On the ground", "Stay where you are, get on the ground! Do it now!", "npc/metropolice/getonground.wav")
Schema.voices.Add("Combine", "Out of there", "Get out of there!", "npc/metropolice/hiding01.wav")
...
Schema.voices.Add("Combine", "Get away", "Don't let him get away!", "npc/metropolice/pointer04.wav")
Schema.voices.Add("Combine", "Getting away", "He's getting away!", "npc/metropolice/pointer06.wav")
...
Schema.voices.Add("Combine", "See him", "Yes, I see him.", "npc/metropolice/shooter05.wav")
